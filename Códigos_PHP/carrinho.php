...
if (isset($_GET['compra_falhou']) && $_GET['compra_falhou'] === 'true') {
 ...
 if ($_GET) { 
    ...
    if ($estoqueSuficiente) {
        ...
        // Aqui você pode definir o status da compra como "Concluída" e fazer outros procedimentos necessários.
        // ...
    header("Location: fim.html");
    exit; 
    } else {
        // Se não houver estoque suficiente, exiba uma mensagem de erro.
