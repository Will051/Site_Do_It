...
<body>
   ...
   <section class='main-home'>
        <div class='main-text'>
            ...
            <h1>Novo Planner<br> ColeÃ§Ã£o 2023</h1>
   ...
   <section class='descricao'>
        ...
        <div class='sobre'><p>
        O vestibular Ã© um dos momentos mais desafiadores na vida de um estudante. A preparaÃ§Ã£o exige dedicaÃ§Ã£o, foco e, acima de tudo, organizaÃ§Ã£o. Afinal, sÃ£o diversas matÃ©rias para estudar, prazos a cumprir e muitos conteÃºdos para revisar. Ã‰ aÃ­ que entra o 'Planejador para Vestibulares', uma ferramenta criada para auxiliar e facilitar a vida dos estudantes nessa jornada tÃ£o importante.

        O principal objetivo desse planner Ã© simplificar o processo de preparaÃ§Ã£o para o vestibular. Ele nÃ£o Ã© apenas uma agenda comum, mas sim uma poderosa ferramenta de organizaÃ§Ã£o. Com ele, os estudantes podem planejar cada etapa do estudo, definir metas, acompanhar o progresso e nunca mais se perder no emaranhado de matÃ©rias e datas.
        </p></div>
   </section>

        <section class='doit-populares'>
            <div class='center-text'>
                <h2>Produtos em <span>PromoÃ§Ã£o</span> </h2>
            </div>
            <!--Produto 1-->
    ...
    <section class='product-slider'>
        ...
        <ul id='autoWidth' class='cs-hidden'>
            ...
            <li class='item-a'>
                <div class='product-box'>
                        <a href='#'>
                            <strong>Kit Ã¡rea de churrasco</strong>
                            <!---IMG---------->
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#autoWidth').lightSlider({
                autoWidth: true,
                loop: true,
                auto: true, // Ativar rolagem automÃ¡tica
